...
function handleNegotiateClick() {
    alert('You clicked Negotiate!');
    // Implement negotiation functionality here
}

// Add event listeners to the buttons
document.getElementById('buyButton').addEventListener('click', handleBuyClick);
document.getElementById('negotiateButton').addEventListener('click', handleNegotiateClick);
